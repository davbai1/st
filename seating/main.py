...
# Уваров, Биктибаев, Зыков, Карапетян, Кузахметов, Вердиев, Шелепов, Иванов Михаил Олегович, Мамакина, Бобуа Андрей Борисович, Гурбанов Нихад Гисметович,
...
"""),
    "manual_assignments": {
        ...
        (2, 3): "Маркин Александр Андреевич",
    }
}
...
# Вместо count*2 мы считаем ровно столько мест, сколько максимум студентов может сесть (по одному на каждый desk)
total_seats = sum(
...
# Составляем DataFrame для визуализации — рисуем все ряды, skip_rows останутся пустыми
rows = []
for r_idx, cfg in enumerate(row_config, start=1):
    col = 1
    seat = 1
